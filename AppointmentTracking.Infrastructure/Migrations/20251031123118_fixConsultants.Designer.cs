...
namespace AppointmentTracking.Infrastructure.Migrations
{
    ...
    [Migration("20251031123118_fixConsultants")]
    partial class fixConsultants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentTracking.Domain.Entities.ConsultantProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AppointmentTracking.Domain.Entities.ConsultantService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ConsultantId", "ServiceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("AppointmentTracking.Domain.Entities.ConsultantProfile", b =>
                {
                    b.HasOne("AppointmentTracking.Domain.Entities.Consultant", "Consultant")
                        ...
                        .HasForeignKey("AppointmentTracking.Domain.Entities.ConsultantProfile", "ConsultantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
